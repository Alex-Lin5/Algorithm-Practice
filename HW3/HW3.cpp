...
void ShortestPath(vector<list<pair<int, int>>>& graph, vector<tuple<int, int, int>>& table, vector<tuple<int, int, int>> & heap, int source);//20 points
void MST(vector<list<pair<int, int>>>& graph, vector<tuple<int, int, int>>& table, vector<tuple<int, int, int>> & heap, int source); //5 points


int main() {
  int source;
  int cost; int from; int id; int hpindex;
  vector<list<pair<int, int>>> graph;
  //your code to read in graph from "graph.txt"

  vector<tuple<int, int, int>> table;//define your tuple
  vector<tuple<int, int, int>> heap; //define your tuple
...
void ShortestPath(vector<list<pair<int, int>>>& graph, vector<tuple<int, int, int>>& table, vector<tuple<int, int, int>> & heap, int source) {

  //Your code  -- HW2A 20 pts
}
void MST(vector<list<pair<int, int>>>& graph, vector<tuple<int, int, int>>& table, vector<tuple<int, int, int>> & heap, int source) {
